  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-4 text-white/80">
        <p>
          CyberLisans olarak kişisel verilerinizin korunması konusunda KVKK ve GDPR
          düzenlemelerine tam uyumlu çalışmaktayız.
        </p>
        <h2 className="font-display text-2xl font-bold text-cyber-magenta">Toplanan Veriler</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-cyber-magenta">Veri Kullanımı</h2>
        <p>
          Siparişlerinizi işlemek, dolandırıcılığı önlemek, yasal yükümlülükleri yerine getirmek
          ve hizmet kalitesini artırmak.
        </p>
        <h2 className="font-display text-2xl font-bold text-cyber-magenta">Çerezler</h2>
        <p>
        ...
        <h2 className="font-display text-2xl font-bold text-cyber-magenta">Haklarınız</h2>
        <p>
