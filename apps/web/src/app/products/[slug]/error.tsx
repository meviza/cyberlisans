...
export default function ProductDetailError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-xl border border-white/30 bg-brand-bg/40 p-8 text-center">
        <h2 className="mb-2 text-2xl font-bold text-white">Ürün detayı yüklenemedi</h2>
